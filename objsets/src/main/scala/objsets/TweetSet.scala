...
object GoogleVsApple {
  ...
  lazy val googleTweets: TweetSet = TweetReader.allTweets.filter(tset => google.exists(word => tset.text.contains(word)))
  lazy val appleTweets: TweetSet = TweetReader.allTweets.filter(tset => apple.exists(word => tset.text.contains(word)))
